...
Utiliser le script fourni `/_archives/sql_obsoletes_2026/add_promo_example.sql` (historique) pour ajouter manuellement des promotions.
...
- Ce document
- `/_archives/sql_obsoletes_2026/add_promo_example.sql` pour exemples SQL (historique)
