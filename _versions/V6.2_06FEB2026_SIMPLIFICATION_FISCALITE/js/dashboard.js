...
async function updateFinancialIndicators() {
    ...
    if (simFiscale && typeof window.calculerChargesParGiteSansAmortissement === 'function') {
        ...
        console.warn('⚠️ Calcul charges impossible - simFiscale ou fonction manquante');
    }
...
async function refreshDashboard() {
    ...
    await updatePropositionsMenage(); // ✅ Propositions changement date ménage
...
// ==========================================
// ANCIEN CODE - DEMANDES CLIENTS (DÉPRÉCIÉ)
// ==========================================
// Table demandes_horaires supprimée de la BDD

async function updateDemandesClients() {
    // ❌ DÉPRÉCIÉ - Table demandes_horaires supprimée
    // Utiliser updatePropositionsMenage() à la place
    return;
}
