        ...
        if (isMobile) {
            ...
            html += `
                <div style="background: #ffffff; border: 2px solid ${giteColor}; padding: 10px; border-radius: 10px; box-shadow: 2px 2px 0 #2D3436; margin-bottom: 8px;">
                    <div style="font-size: 0.8rem; font-weight: 700; color: var(--text); margin-bottom: 6px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${r.nom}</div>
                ...
                <div class="dashboard-reservation-card" style="border-color: ${giteColor};">
                    <div class="dashboard-reservation-content">
                        <div class="dashboard-reservation-info">
                            <strong class="dashboard-reservation-name">${r.nom}</strong>
                    ...
                    <div class="dashboard-reservation-actions">
                        ${showFicheButton ? `
            ...
            html += `
                <div class="dashboard-todo-item">
                    ...
                    <div class="dashboard-todo-content">
                        ...
                        ${todo.description ? `<div class="dashboard-todo-description">${todo.description}</div>` : ''}
                        <div class="dashboard-todo-badges">
                            ${giteName ? `<span class="gite-badge">${giteName}</span>` : ''}
