...
### 🎨 Views (6 fichiers principaux)
- ✅ **LoginView.swift** - Connexion avec Face ID/Touch ID, RegisterView
- ✅ **DashboardView.swift** - Tableau de bord (KPIs, réservations, ménages, alertes)
- ✅ **CalendarView.swift** - Calendrier mensuel avec réservations (grille 7 jours)
