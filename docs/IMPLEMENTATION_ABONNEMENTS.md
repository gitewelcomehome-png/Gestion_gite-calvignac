...
- **🎥 Webinaire mensuel collectif** : Présentation + Q&A en groupe
- Export Excel avancé + PDF

**Support :** ✉️ Email VIP (réponse sous 4h ouvrées) + 💬 Chat prioritaire
...
('quattro', 'QUATTRO', 3, 33.00, 23.00, 4, '{
  ...
  "formation": "webinar_monthly",
  "export_level": "excel_advanced"
}'::jsonb);
