...
export function sanitizeHTML(dirty, config = {}) {
    ...
    const defaultConfig = {
        ...
        ALLOWED_ATTR: ['href', 'title', 'target', 'style', 'class', 'type', 'data-activite-id', 'src', 'alt', 'onclick', 'onmouseover', 'onmouseout', 'id', 'name', 'value', 'placeholder', 'required', 'disabled', 'checked', 'selected', 'for', 'min', 'max', 'step', 'pattern', 'maxlength', 'minlength', 'rows', 'cols', 'readonly', 'autocomplete', 'multiple', 'size', 'onchange', 'oninput', 'onsubmit', 'onfocus', 'onblur'],
