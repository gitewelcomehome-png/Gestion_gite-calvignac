...
function showCleaningRulesModal() {
    ...
    modal.innerHTML = `
        <div style="background: white; border: 3px solid #2D3436; border-radius: 16px; box-shadow: 8px 8px 0 #2D3436; max-width: 900px; width: 100%; max-height: 85vh; overflow-y: auto; margin: auto;">
